        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">Relacionar usuarios</div>
                    @if(Session::has('message'))
                        <p class="alert-success">{{ Session::get('message') }}</p>
                    @endif
                    <div class="panel-body">
                        @include('admin.partials.messages')
                        {!! Form::open(['route'=> 'admin.usuariosxciclo.store', 'method' => 'POST' ]) !!}
                        @include('admin.ciclos.usuariosxciclo.partials.fields')

                        <button type="submit" class="btn btn-info">Relacionar usuario
                        </button>
