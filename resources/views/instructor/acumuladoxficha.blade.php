                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="panel-group">
                            <a class="btn btn-success btn-xs pull-right btn-sm RbtnMargin" href="{{  \Illuminate\Support\Facades\URL::to('/eventos/acumuladoxfichaexcel?userId='.$user->id.'&start='.$start.'&end='.$end) }}">Exportar excel</a>
                        ...
                        {!! Form::model(['start'=>$start,'end'=>$end],['action'=> 'EventosController@acumuladoxficha', 'method'=>'GET', 'class'=>'navbar-form navbar-left pull-right form-inline', 'role'=>'search' ]) !!}
