...
app.service('sigaService',function($http,$q){
    //var tareas = [];
    this.tareas = [];
    this.listaTareas = [];
    this.files = [];
    ...
    * */
    ...
    this.updateLista = function(lista){
     ...
     this.getProcedimientos = function(){
       var deferred = $q.defer();
       $http.get('/api/siga/lista')
        .success(function(data, status, headers, config){
    ...
    this.getActividadesLista = function(lista){ // la primer carga de la pagina
        var deferred = $q.defer();
         $http.get('/api/siga/actividades/' + lista).//metodo para obligar a esperar la carga de los datos la primer vez
            success(function(data, status, headers, config) {
                this.tareas = data;
                deferred.resolve(data);
